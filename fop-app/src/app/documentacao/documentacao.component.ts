...
export class DocumentacaoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.doc1.link.push("../../assets/FOP_Informa_119.pdf");
    ...
    this.doc2.link.push("../../assets/FOP_Informa_118.pdf");
    ...
    this.doc3.link.push("../../assets/Fop_Informa_117_Classes_FOP_para_exposições_2016.pdf");
    ...
    this.doc4.link.push("../../assets/Lista_de_Classes_FOP_2016.pdf");
    ...
    this.doc5.link.push("../../assets/FOP_Informa_116_Classes_FOP_para_exposições_2016.pdf");
    ...
    this.doc6.link.push("../../assets/FOP_Informa_115.pdf");
    ...
    this.doc7.link.push("../../assets/FOP_Informa_114_Anilhas.pdf");
    ...
    this.doc8.link.push("../../assets/FOP_Informa_113_Anilhas.pdf");
    ...
    this.doc9.link.push("../../assets/FOP_Informa_111.pdf");
    ...
    this.doc10.link.push("../../assets/FOP_Informa_109.pdf");
    ...
    this.doc11.link.push("../../assets/FOP_Informa_108.pdf");
    ...
    this.doc12.link.push("../../assets/FOP_Informa_107.pdf");
    ...
    this.doc13.link.push("../../assets/Lista_de_Classes_FOP_2014.pdf");
    ...
    this.doc14.link.push("../../assets/FOP_Informa_106.pdf");
    ...
    this.doc15.link.push("../../assets/FOP_Informa_105.pdf");
    ...
    this.doc16.link.push("../../assets/FOP_Informa_104.pdf");
    ...
    this.doc17.link.push("../../assets/FOP_Informa_103.pdf");
    ...
    this.doc18.link.push("../../assets/FOP_Informa_102.pdf");
    ...
    this.doc18.link.push("../../assets/ConvAGFOP20140329.pdf");
    ...
    this.doc19.link.push("../../assets/ContasFOP2013.pdf");
    ...
    this.doc20.link.push("../../assets/FOP_Informa_101.pdf");
    ...
    this.doc21.link.push("../../assets/FOP_Informa_100.pdf");
    ...
    this.doc22.link.push("../../assets/FOP_Informa_099.pdf");
    ...
    this.doc23.link.push("../../assets/FOP_Informa_098.pdf");
    ...
    this.doc24.link.push("../../assets/FOP_Informa_097.pdf");
    ...
    this.doc25.link.push("../../assets/CLASSES_2013_CTJ_FOP.pdf");
    ...
    this.doc26.link.push("../../assets/FOP_Informa_094.pdf");
    this.doc26.link.push("../../assets/Caderno_de_Encargos_Aprovado.pdf");
    ...
    this.doc28.link.push("../../assets/FOP_Informa_092.pdf");
    ...
    this.doc30.link.push("../../assets/FOP_Informa_090.pdf");
    ...
    this.doc31.link.push("../../assets/FOP_Informa_088.pdf");
    this.doc31.link.push("../../assets/FOP_contas_2012.pdf");
    ...
    this.doc32.link.push("../../assets/FOP_Informa_086.pdf");
    this.doc32.link.push("../../assets/convag20130407.pdf");
    ...
    this.doc33.link.push("../../assets/FOP_Informa_084.pdf");
    ...
    this.doc34.link.push("../../assets/FOP_Informa_083.pdf");
    this.doc34.link.push("../../assets/PARECER_FISCAL_SOBRE_A_ATIVIDADE_DA_FOP.pdf");
    ...
    this.doc35.link.push("../../assets/FOP_Informa_082.pdf");
    ...
    this.doc36.link.push("../../assets/FOP_Informa_081.pdf");
    ...
    this.doc37.link.push("../../assets/FOP_Informa_080.pdf");
    this.doc37.link.push("../../assets/AnilhasMedidas2013.pdf");
    ...
    this.doc38.link.push("../../assets/FOP_Informa_079.pdf");
    ...
    this.doc38.link.push("../../assets/Comunicado20120523.pdf");
    ...
    this.doc39.link.push("../../assets/FOP_Informa_078.pdf");
    ...
    this.doc40.link.push("../../assets/FOP_informa_077.pdf");
    this.doc40.link.push("../../assets/FOPContas2011.pdf");
    this.doc40.link.push("../../assets/AG20120331.pdf");
    ...
    this.doc41.link.push("../../assets/fop_informa_076.pdf");
    ...
    this.doc42.link.push("../../assets/fop_informa_075.pdf");
    ...
    this.doc43.link.push("../../assets/Impresso_RECLAMAÇÃO_ANILHAS.doc");
    ...
    this.doc44.link.push("../../assets/FOP_Informa_073.pdf");
    this.doc44.link.push("../../assets/FOPvodafone.pdf");
    this.doc44.link.push("../../assets/VodafoneCedencialNumero.pdf");
    this.doc44.link.push("../../assets/VodafonePortabilidade_Outros_Operadores.pdf");
    ...
    this.doc45.link.push("../../assets/FOP_Informa_071.pdf");
    ...
    this.doc46.link.push("../../assets/Caderno_de_Encargos_Aprovado.pdf");
    ...
    this.doc47.link.push("../../assets/CartaClubesCandNacional2011.pdf");
    ...
    this.doc48.link.push("../../assets/FOP_Informa_067.pdf");
    ...
    this.doc48.link.push("../../assets/FOP_Informa_066.pdf");
    ...
    this.doc49.link.push("../../assets/FOP_Informa_065.pdf");
    ...
    this.doc50.link.push("../../assets/FOP_Informa_064.pdf");
    ...
    this.doc51.link.push("../../assets/FOP_Informa_063.pdf");
    ...
    this.doc52.link.push("../../assets/FOP_Informa_062.pdf");
    ...
    this.doc53.link.push("../../assets/FOP_Informa_061.pdf");
    ...
    this.doc54.link.push("../../assets/ListagemSociosClubes060.xls");
    ...
    this.doc55.link.push("../../assets/FOP_Informa_059.pdf");
    ...
    this.doc56.link.push("../../assets/FOP_Informa_058.pdf");
    this.doc56.link.push("../../assets/NIB-FOP059.pdf");
    ...
    this.doc57.link.push("../../assets/FOP_Informa_057.pdf");
    this.doc57.link.push("../../assets/Impresso_Requisição_CCN.xls");
    ...
    this.doc58.link.push("../../assets/FOP_Informa_056.pdf");
    this.doc58.link.push("../../assets/Impresso_Pedido_STAM.xls");
    ...
    this.doc59.link.push("../../assets/FOP_Informa_055.pdf");
    this.doc59.link.push("../../assets/Clubes_Pedido_de_Reembolso-Kms.doc");
